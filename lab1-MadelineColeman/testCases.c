...
//=================Question 7================================  
    ...
    void TestQ7b_neg(CuTest *tc) {
        int input = -4989;
        int actual = Q7b(input);
        int expected = -9894;
        CuAssertIntEquals(tc, expected, actual);
    }
    void TestQ7b_trail_0(CuTest *tc) {
        int input = 123000;
        int actual = Q7b(input);
        int expected = 321;
        CuAssertIntEquals(tc, expected, actual);
    ...
    CuSuite* Lab1GetSuite() {
        ...
        SUITE_ADD_TEST(suite, TestQ4_neg_1);
        ...
        SUITE_ADD_TEST(suite, TestQ6_0);
        

        SUITE_ADD_TEST(suite, TestQ7a_1);
        SUITE_ADD_TEST(suite, TestQ7a_2);
        SUITE_ADD_TEST(suite, TestQ7a_neg);
        SUITE_ADD_TEST(suite, TestQ7b_1);
        SUITE_ADD_TEST(suite, TestQ7b_2);
        SUITE_ADD_TEST(suite, TestQ7b_neg);
        SUITE_ADD_TEST(suite, TestQ7b_trail_0);
