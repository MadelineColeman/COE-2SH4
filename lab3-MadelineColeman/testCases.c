...
void TestQ1_character(CuTest *tc) {

	CuAssertStrEquals(tc, "ab", my_strcat("a", "b"));
}
...
void TestQ2_destroy(CuTest *tc) {
	...
	output_final_course_grades("destroy.txt", Clist, size);

	//now we open the golden file with the written file and compare line by line

	char actualFile[] = "destroy.txt";
	char goldenFile[] = "destroyOutput.txt";
...
void TestQ2_withdraw_in(CuTest *tc) {
	...
	output_final_course_grades("withdraw.txt", Clist, size);

	//now we open the golden file with the written file and compare line by line

	char actualFile[] = "withdraw.txt";
	char goldenFile[] = "withdrawOutput.txt";
...
void TestQ2_withdraw_not(CuTest *tc) {
	...
	output_final_course_grades("withdrawNot.txt", Clist, size);

	//now we open the golden file with the written file and compare line by line

	char actualFile[] = "withdrawNot.txt";
	char goldenFile[] = "withdrawNotOutput.txt";
...
void TestQ3_readandSort1(CuTest *tc) {
	...
	char *expectedList[] = { "apple", "banana", "hello", "milan", "programming",
			"zebra" };
...
CuSuite* Lab3GetSuite() {
	...
	SUITE_ADD_TEST(suite, TestQ1_character);
	...
	SUITE_ADD_TEST(suite, TestQ2_destroy);
	SUITE_ADD_TEST(suite, TestQ2_withdraw_in);
	SUITE_ADD_TEST(suite, TestQ2_withdraw_not);
