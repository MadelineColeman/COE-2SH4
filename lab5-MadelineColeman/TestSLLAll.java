...
public class TestSLLAll {
	...
	@Test
	public void testSLLSetIntArray1() {

		int[] arr = { 0 }; // this list

		SLLSet listObj2 = new SLLSet(arr);
		String expectedSet = "0";
		int expectedSize = 1;
		assertEquals(expectedSize, listObj2.getSize());
		assertEquals(expectedSet, listObj2.toString());
	}
	...
	public void testCopy1() {
		...
		SLLSet copied = listObj2.copy();
		copied.add(1);
		String expectedObj2 = "0";
		String expectedCopied = "0, 1";
	...
	@Test
	public void testIsInNeg() {

		int[] arr = { 1, 2, 3, 7, 8 }; // this list
		SLLSet listObj2 = new SLLSet(arr);

		int notin = -1; // test isIn
		boolean expected = false;
	...
	public void testIntersection5() {
		...
		int[] arr = { 0 }; // this list
		int[] inter3 = { 0 }; // test intersection
	...
	public void testDifference5() {
		...
		// test difference
		SLLSet listObj2 = new SLLSet(arr);
		SLLSet listObj17 = new SLLSet(arr);
		SLLSet listObj1000 = listObj17.difference(listObj2);
	...
	@Test
	public void testUnionSLLSetArray1() {

		int[] arr1 = { 0 };
		int[] arr2 = { 1 };
		SLLSet listObj100 = new SLLSet(arr1);
		SLLSet listObj99 = new SLLSet(arr2);
		SLLSet[] Array = { listObj100, listObj99 }; // test static SLLSet union(sArray)
